...
namespace ProyectoFinalPWA.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            _emailSender.SendEmailAsync(orderHeader.ApplicationUser.Email, "<p>Nueva Orden - Proyecto Final PWA", $"<p>Tienes una nueva orden con ID: {orderHeader.Id}</p>");
        ...
        {
            var cartFromDb = _unitOfWork.ShoppingCart.GetFirstOrDefault(crt => crt.Id == cartId);
            cartFromDb.Count += 1;
        ...
        {
            var cartFromDb = _unitOfWork.ShoppingCart.GetFirstOrDefault(crt => crt.Id == cartId, tracked: true);

            if (cartFromDb.Count <= 1)
            {
                HttpContext.Session.SetInt32(SD.SessionCart,
              _unitOfWork.ShoppingCart.GetAll(sC => sC.ApplicationUserId == cartFromDb.ApplicationUserId).Count() - 1);
